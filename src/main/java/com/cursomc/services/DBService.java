...
public class DBService {
	...
	@Autowired
	private EstadoRepositorio estadoRepository;
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cidade c3 = new Cidade(null, "Brasilia", est3);
		...
		Cliente cli1 = new Cliente(null, "Marcus Dimitri B.Costa", "marcusdbcosta@gmail.com", "90542630168",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("9981724650", "9981724650"));
		...
		Endereco e3 = new Endereco(null, "Rua Manaca sul", "4", null, "Aguas Claras", "71936500", cli1, c3);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/09/2017 10:32"), cli1, e3);
